...
const NewsItem = (props) => {
  let { title, desc, imgUrl, newsUrl, time, author, source } = props;
  //css
  const imgSet = {
    aspectRatio: "16/9",
    objectFit: "cover",
  ...
  return (
    <div className="h-100">
      <div className="card h-100">
        <div
          className="position-absolute end-0 top-0 d-flex justify-content-end"
          style={{ zIndex: "1" }}
        >
        ...
        <div className="card-body">
          <p className="card-text">
            <small>
              By <strong>{!author ? "Unknown" : author}</strong> <br />
